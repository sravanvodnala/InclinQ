...
#undef strong_delegate
#if __has_feature(objc_arc) && __has_feature(objc_arc_strong)
#define strong_delegate strong
#else
#define strong_delegate unsafe_unretained
#endif
...
@property (nonatomic, strong_delegate) IBOutlet id<SwipeViewDataSource> dataSource;
@property (nonatomic, strong_delegate) IBOutlet id<SwipeViewDelegate> delegate;
